...
public class Main {
    public static void main(String[] args) {
        ...
        Laptop macbook_17pro = new Laptop("macbook_17pro", 17, "4k",
                false, 1000, "16", "MacOS", "silver");
        Brand brandMacbook = new Brand("Apple", "U.S.A.", "AmericaLanguage");
        macbook_17pro.addBrand(brandMacbook);
        Laptop asus_x515 = new Laptop("asus_x515", 17, "FullHD",
                true, 300, "4", "Windows", "silver");
